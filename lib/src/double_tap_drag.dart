...
import 'double_tap_and.dart';

/// All code in this file is adapted form Flutter's DragGestureDetector

class DoubleTapDragGestureDetector extends StatelessWidget {
  const DoubleTapDragGestureDetector({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return RawGestureDetector(
      ...
      gestures: <Type, GestureRecognizerFactory>{
        DoubleTapPanGestureRecognizer: GestureRecognizerFactoryWithHandlers<DoubleTapPanGestureRecognizer>(
          () => DoubleTapPanGestureRecognizer(debugOwner: this),
          (DoubleTapPanGestureRecognizer instance) {
            instance
...
class DoubleTapPanGestureRecognizer extends DoubleTapDragGestureRecognizer {
  /// Create a gesture recognizer for tracking movement on a plane.
  DoubleTapPanGestureRecognizer({Object? debugOwner}) : super(debugOwner: debugOwner);

  @override
  bool isFlingGesture(VelocityEstimate estimate, PointerDeviceKind kind) {
    final minVelocity = minFlingVelocity ?? kMinFlingVelocity;
    final minDistance = minFlingDistance ?? computeHitSlop(kind);
...
abstract class DoubleTapDragGestureRecognizer extends DoubleTapAndGestureRecognizer {
  ...
  /// Whether to start panning immediately after the double tap or require the pointer
  /// to drag a minimum distance
  ...
  void handleEvent(PointerEvent event) {
    ...
    if (event is PointerMoveEvent) {
      ...
      if (_state == _DragState.accepted) {
        ...
        if (immediate || _hasSufficientGlobalDistanceToAccept(event.kind)) {
          resolve(GestureDisposition.accepted);
        }
      }
    }
  ...
  void rejectSecondGesture(int pointer) {
    super.rejectSecondGesture(pointer);
